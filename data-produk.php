...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">Eventics</a></h1>
			<ul>
			...
			<div class="box">
				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						<?php
							$no = 1;
							$produk = mysqli_query($conn, "SELECT * FROM tb_product LEFT JOIN tb_kategory USING (id_category) ORDER BY id_product DESC");
						...
						<tr>
							...
							<td><a href="produk/<?php echo $row['image_product'] ?>" target="_blank"> <img src="produk/<?php echo $row['image_product'] ?>" width="50px"> </a></td>
